...
function hideSemantic() {
  w3.addClass("header", "visually-hidden opacity-0");
  w3.addClass("main", "visually-hidden opacity-0");
  w3.addClass("footer", "visually-hidden opacity-0");
}
function showSemantic() {
  w3.removeClass("header", "visually-hidden opacity-0");
  w3.removeClass("main", "visually-hidden opacity-0");
  w3.removeClass("footer", "visually-hidden opacity-0");
}
